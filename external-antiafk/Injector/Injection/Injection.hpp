...
void test_print() {
    uintptr_t RobloxBase = (uintptr_t)GetModuleHandleA(nullptr);
    auto RbxPrint = (void(__fastcall*)(int, const char*, ...))(RobloxBase + 0x14D2A10);
    auto RbxAntiAfk = (__int64(__fastcall*)(__int64, const char*, int*, __int64))(RobloxBase + 0x390A130);
    __int64 RbxMonitor = *(__int64*)(RobloxBase + 0x61278C8);
    RbxPrint(0, "ANTIAFK - LAUNCHED!");
    RbxPrint(0, "Monitor Ptr: %p", (void*)RbxMonitor);
    int timeout_seconds = 746914832; // total of 1 week
    RbxAntiAfk(RbxMonitor, "PartyPlayerInactivityTimeoutInSeconds", &timeout_seconds, 1);
}
